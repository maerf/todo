        ...
        <Draggable draggableId={node.id} index={index}>
            {provided => (
                <Box
                    ...
                    <ListItem>
                        {node.isTodo && (
                            <ListItemIcon role={undefined} onClick={e => onTodoToggle(e, node, node.id)}>
                                <Checkbox edge='start' checked={node.isDone || false} disableRipple />
                            </ListItemIcon>
                            // <ListItemIcon>
                            //     <Checkbox edge='start' onChange={e => onTodoToggle(e, node, node.id)} checked={node.isDone || false} tabIndex={-1} disableRipple />
                            // </ListItemIcon>
                        )}
