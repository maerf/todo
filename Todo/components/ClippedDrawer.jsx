...
export default function ClippedDrawer({ setNodes, nodes, children }) {
    ...
    useEffect(() => {
        dispatch(addTagsArray({ nodeId: "1", tags: ["tag1", "tag2"] }));
    ...
    //     .map((entry, index) => {
    //         console.log("maptes", entry.text);
    //     });

    return (
        <Box sx={{ display: "flex", backgroundColor: "yellow", height: "100vh" }}>
            <CssBaseline />
            <AppBar position='fixed' sx={{ zIndex: theme => theme.zIndex.drawer + 1 }}>
                <Toolbar>
            ...
            <Drawer
                ...
                <Box sx={{ overflow: "auto" }}>
                    <List>
                        ...
                        <Divider />
                        <ListItem component={RouterLink} to='/notes' button>
                            <ListItemIcon>
                                <NotesIcon />
                            </ListItemIcon>
                        ...
                        <Collapse in={tasksDrawerOpen} timeout='auto' unmountOnExit>
                            <List component='div' disablePadding>
                                <ListItemButton onClick={() => dispatch(increment())} sx={{ pl: 4 }}>
                                    <ListItemIcon>
                                        <InboxIcon />
                                    </ListItemIcon>
                                    <ListItemText primary={"Inbox " + count} />
                                </ListItemButton>
                                ...
                                <ListItemButton component={RouterLink} to='/tasks/next' sx={{ pl: 4 }}>
                                    <ListItemIcon>
                                        <InboxIcon />
                                    </ListItemIcon>
            ...
            <Box component='main' sx={{ backgroundColor: "orange", width: "100%", height: "100%", marginTop: "64px" }}>
                {/*sx={{ flexGrow: 1, p: 3 }}*/}
                {children}
            </Box>
        </Box>
