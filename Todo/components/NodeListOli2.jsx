        ...
        <>
            ...
            {nodes[parentNodeId]?.childIds && selectedNode && (
                <>
                    ...
                    <RenderNode parentNode={selectedId} nodes={nodes} setNodes={setNodes} />
                </>
            )}
        </>
    );
...
export default function NodeList() {
    ...
    React.useEffect(() => {
        const nodes = {
            0: { id: "0", parentId: "root", isRoot: true, text: "I'm the root", childIds: ["1"], tasksIds: [] },
            1: { id: "1", parentId: "0", isRoot: false, text: "I'm a parent", childIds: ["2"], tasksIds: [] },
            2: { id: "2", parentId: "1", isRoot: false, text: "I'm a child", childIds: [], tasksIds: [] },
        };
